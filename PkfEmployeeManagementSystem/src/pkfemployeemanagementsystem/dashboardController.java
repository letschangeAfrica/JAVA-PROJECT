 ...
 */
package pkfemployeemanagementsystem;
...
public class dashboardController implements Initializable{
    ...
    private String[] positionList = {"Faculty", "Administrative Staff", "Technical Staff", "Student Worker"};
    ...
    public void switchForm(ActionEvent event){
        ...
        if(event.getSource() == home_btn){
            ...
            home_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #00008b, #FFD700)");
            ...
            addEmployee_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #00008b, #FFD700)");
            ...
            salary_btn.setStyle("-fx-background-color:linear-gradient(to bottom right, #00008b, #FFD700)");
            addEmployee_btn.setStyle("-fx-background-color:transparent");
